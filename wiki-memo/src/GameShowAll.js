            ...
            <div className="row ms-3 mb-4 me-2 mh-25" style={{ "overflow":"hidden", }}>
                <div className="col-sm-3">
                   <div style=
                    ...
                    <small className="image-credit"><a className="link-light" href={d.img_info_url}>Picture:</a> {d.img_artist} <a className="link-light" href={d.img_license_link}>{d.img_license}</a></small>
                </div>
                <div className="col-sm-9" style={{"maxHeight":"200px"}}>
                    
                    <h4 className="mt-3 mt-sm-0">{d.title} <a className="link-light" href={d.link} target="_blank"  rel="noreferrer"><BoxArrowUpRight className="mb-1 ms-2" size={16} /></a></h4>
    ...
    return (
        <>
            <h1 className="ms-4 mb-5 mt-4">All Cards used  
                <button className='btn btn-outline-light btn-sm ms-3 mb-1' onClick={handleClick}>Restart Game 
